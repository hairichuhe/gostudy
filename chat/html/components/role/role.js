define('role', function(require, exports, module) {
  ...
  module.exports = Vue.extend({
      ...
      data: function() {
          ...
          return {
          	page:pg,
              queryarr:[
              {name:"filter_LIKES_name",placeholder:"输入想查询的角色名称"},
              {name:"filter_LIKES_chineseName",placeholder:"输入想查询的角色中文名称"}
              ],
          	gridColumns:[
               {name:'name',displayName:'角色名称'}, 
               {name:'chineseName',displayName:'角色中文名称'},
      ...
      methods:{
          ...
          search:function (){
              $("#roleRoot form#query-form input#pageNo").val("1");
          	this.$refs.grid.query();
          },goAdd:function(){
          	routers.route.go({ path: '/role-input/'+'-1', params: { id: '-1' }}) 
  		},goEdit:function(v){
  			...
  			if(null != nid){
  				...
  				routers.route.go({ path: '/role-input/'+nid, params: { id: nid }})
              }
