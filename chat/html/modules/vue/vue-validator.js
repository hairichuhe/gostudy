define('vue-validator', function(require, exports, module) {
  ...
  (function (global, factory) {
    ...
    function remote(val,url) {
      ...
      if(val.trim()!=''){
          ...
          if(!(dataS.originalName && dataS.originalName==val)){
    ...
    function isMobile(val) {
      if(val.trim()!=''){
        return (/^(((1[3578][0-9]{1})|(15[0-9]{1}))+\d{8})$/.test(val)
        );
      }else{
        return true
      }   
     ...
     * isUrl
     *
     * This function check whether the value of the Url
     *
